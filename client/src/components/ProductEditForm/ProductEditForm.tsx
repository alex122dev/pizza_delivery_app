...
export const ProductEditForm: React.FC<IProps> = ({
  ...
  const [isComponentsModalActive, setIsComponentsModalActive] = useState(false);
        ...
        <Form className={styles.formBody}>
          ...
          <div className={styles.imageBlock}>
            {product?.image && !imageFile && (
              <div className={styles.previewBlock}>
                <h4 className={styles.imageTitle}>Current Image</h4>
                <ImagePreview image={product.image} />
              </div>
            )}
            {croppedImageFile && (
              <div className={styles.previewBlock}>
                <h4 className={styles.imageTitle}>New Image Preview</h4>
            ...
            <input
              ...
              ref={fileInputRef}
              onChange={(e: any) => {
                imageFileValidate(e.target.files?.[0], setImageFile);
              }}
            />
            <CustomButton
              startColor='blue'
          ...
          <div className={styles.textBlock}>
            ...
            <Field
              ...
              uniqueId={product?.id || 'createNewProductCheckboxId'}
              component={CustomFormikCheckboxField}
            />
            {renderComponents(values.componentIds || [], setFieldValue)}
            <CustomButton
              startColor='blue'
            ...
            </CustomButton>
            {
              <ChooseComponentsModal
                ...
                componentIds={values.componentIds || []}
                setFieldValue={(v) => setFieldValue('componentIds', v)}
              />
            }
