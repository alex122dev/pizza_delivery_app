...
export const AdminOrderEditWindow: React.FC<IProps> = ({ order }) => {
  ...
  const [localOrderItems, setLocalOrderItems] = useState<CreateOrderItemDto[]>(
    order.orderItems,
  );
  ...
  const renderRemoveLocalOrderItemButton = (orderItem: CreateOrderItemDto) => {
    return (
      <CloseButton
        onClick={() => {
          setLocalOrderItems(
    ...
    return (
      ...
      >
        <div className={styles.modalBody}>
          ...
          />
          <h2 className={styles.modalTitle}>Add Product To Customer Order</h2>
          <Products
  ...
  return (
    <div className={styles.container}>
      <div className={styles.orderForm}>
        ...
        <EditOrderForm order={order} localOrderItems={localOrderItems} />
      </div>
